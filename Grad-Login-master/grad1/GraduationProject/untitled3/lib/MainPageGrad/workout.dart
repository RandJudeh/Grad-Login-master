                ...
                children: [ Text(
                  ...
                  steps: [
                    Step(
                      ...
                      content: Column(
                        children: [
                          TextFormField(
                            controller: monday,
                            decoration: InputDecoration(labelText: 'hour/s',
                            ),
                          )
                        ],
                      ),
                    ...
                    Step(
                      ...
                      title: Text('Tuesday'), content: Column(
                      children: [
                        TextFormField(
                          controller: tuesday,
                          cursorWidth:30,
                    ...
                    Step(
                      ...
                      title: Text('Wednesday'), content: Column(
                      children: [
                        TextFormField(
                    ...
                    Step(
                      ...
                      title: Text('Thursday'), content: Column(
                      children: [
                        TextFormField(
                          controller: thursday,
                          cursorWidth:30,
                      ...
                      title: Text('Friday'), content: Column(
                      children: [
                        TextFormField(
                          controller: friday,
                          cursorWidth:30,
                    ...
                    Step(
                      ...
                      title: Text('Saturday'), content: Column(
                      children: [
                        TextFormField(
                          controller: saturday,
                          cursorWidth:30,
                      ...
                      title: Text('sunday'), content: Column(
                      children: [
                        TextFormField(
                          controller: wednesday,
                          cursorWidth:30,
